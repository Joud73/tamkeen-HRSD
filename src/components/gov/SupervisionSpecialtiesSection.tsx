  ...
  return (
    <section dir="rtl" className="relative bg-[#f8f9fa] py-16 overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-16 relative z-10">
        ...
        <div className="mb-12">
          <h2 
            className="text-3xl md:text-4xl font-bold text-[#f5961e] mb-4 text-right"
            style={{ fontFamily: "'HRSDGov-Bold', 'Cairo', system-ui, sans-serif" }}
          >
            إختصاصات الإشراف الفني
          </h2>
          {/* Decorative lines */}
          <div className="flex justify-end gap-2">
            <div className="w-24 h-1 bg-[#1a9b8e] rounded-full" />
              ...
              >
                <div className={`flex items-center gap-6 ${isRightColumn ? 'flex-row' : 'flex-row-reverse'}`}>
                  ...
                  <p 
                    ...
                    style={{ fontFamily: "'HRSDGov-Regular', 'Cairo', system-ui, sans-serif" }}
                  >
                    {item.text}
                  </p>
                </div>
      ...
      {/* Orange side tab decoration (like screenshot) */}
      <div className="absolute left-0 top-1/2 -translate-y-1/2 hidden lg:block">
        <div className="bg-[#f5961e] text-white py-6 px-2 rounded-r-lg writing-mode-vertical">
          <span 
