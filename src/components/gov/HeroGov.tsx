  ...
  return (
    <section dir="rtl" className="relative min-h-[85vh] bg-[#1D4D37]">
      ...
      <div className="h-full flex items-center justify-start">
        <div className="w-full max-w-[600px] py-24 md:py-32 lg:py-40 pl-8 md:pl-16 lg:pl-24 xl:pl-32 text-left">
          {/* Main Headline */}
          <h1
          ...
          {/* Subtitle - two lines */}
          <p
            className="text-white/80 text-sm md:text-base lg:text-lg leading-relaxed mb-8 max-w-2xl ml-0"
            style={{
