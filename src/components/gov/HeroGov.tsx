  ...
  return (
    <section dir="rtl" className="relative min-h-[85vh] bg-[#1D4D37]">
      ...
      <div className="h-full flex items-center">
        <div className="w-full pl-4 md:pl-12 lg:pl-24 xl:pl-32 pr-8 md:pr-16 lg:pr-24">
          <div className="max-w-4xl ml-auto py-24 md:py-32 lg:py-40 text-right">
            {/* Main Headline */}
            <h1
              className="text-white text-3xl lg:text-5xl xl:text-[56px] leading-[1.4] mb-8 md:text-3xl"
              style={{
            ...
            {/* Subtitle */}
            <p
              className="text-white/90 text-base md:text-lg lg:text-xl leading-relaxed mb-10 max-w-3xl"
              style={{
