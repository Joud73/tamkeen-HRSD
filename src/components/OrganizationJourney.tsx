import { UserPlus, Compass, ClipboardCheck, BookOpen, GraduationCap, Upload, Brain, Users, Award } from "lucide-react";
...
const steps = [
  { id: 1, title: "التسجيل", description: "تسجيل الدخول", icon: UserPlus, path: "/login" },
  {
    ...
    description: "التقييم الذكي ورفع الشواهد",
    icon: ClipboardCheck,
    path: "/dashboard",
  },
  ...
  return (
    <section className="py-6 px-4 md:px-6 bg-white overflow-x-auto" dir="rtl">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-xl md:text-2xl font-hrsd-title text-center mb-6" style={{ color: "hsl(35, 91%, 54%)" }}>
          رحلة المنظمة
        </h2>
              ...
              return (
                ...
                >
                  ...
                  <div className={`absolute bottom-full mb-2 text-center w-20 ${isTop ? "block" : "invisible"}`}>
                    ...
                    <p className="text-[10px] text-gray-500 mt-0.5 leading-tight font-hrsd">{step.description}</p>
                  </div>
                    ...
                    >
                      ...
                      >
                        <Icon
                          className="w-5 h-5"
                          style={{
                            color: isCurrent ? "hsl(35, 91%, 54%)" : "hsl(175, 75%, 30%)",
                          }}
                          strokeWidth={1.5}
                        />
                      </div>
