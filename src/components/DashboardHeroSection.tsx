      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <p className="text-lg md:text-xl text-muted-foreground font-hrsd-medium leading-relaxed">
            ستمر منظمتكم برحلة تقييم منظمة ومتدرجة، مقسمة إلى مراحل واضحة تهدف إلى تطوير الأداء وتعزيز القدرات — وليس للتفتيش أو المراقبة.
          </p>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 md:gap-4">
            {journeySteps.map((step, index) => (
              <div key={index} className="flex flex-col items-center text-center relative z-10">
                ...
                {/* Step Title */}
                <h3 className="text-lg font-hrsd-semibold text-foreground mb-1">
                  {step.title}
                </h3>
                
                {/* Step Description */}
                <p className="text-sm text-muted-foreground font-hrsd max-w-[140px]">
                  {step.description}
                </p>
            ...
            <div className="flex flex-col items-center text-center relative z-10">
              ...
              {/* Step Title */}
              <h3 className="text-lg font-hrsd-bold text-accent mb-1">
                النتيجة النهائية
              </h3>
              
              {/* Step Description */}
              <p className="text-sm text-muted-foreground font-hrsd max-w-[160px]">
                تقييم شامل وخطة تطوير مخصصة
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-section-light rounded-lg p-6 md:p-8 max-w-4xl mx-auto mb-12">
          <p className="text-center text-muted-foreground font-hrsd-medium mb-6">
            هيكلة التقييم
          </p>
          ...
          <div className="bg-gradient-to-br from-primary/5 to-transparent rounded-xl p-6 md:p-8 border border-primary/10">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-hrsd-semibold text-foreground mb-3">
                  ماذا ستحصلون عليه؟
                </h3>
